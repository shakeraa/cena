...
- **Blocks**: prr-003a (ADR — this conflict IS the decision it resolves), prr-003b (impl). Note: prr-038 was superseded by prr-003a on 2026-04-20 — same ADR scope, no longer a separate block.
