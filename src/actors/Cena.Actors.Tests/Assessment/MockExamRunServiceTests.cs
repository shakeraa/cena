...
//
// Setup / teardown / helpers live in MockExamRunServiceTestsFixtures.cs
// (partial sibling). This file owns assertions only — keeps it under the
// 500-LOC ratchet (FileSize500LocTest, ADR-0012).
// =============================================================================
...
public sealed partial class MockExamRunServiceTests
{
    [Fact]
