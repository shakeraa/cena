...
// ADR-0047: TutorMessageService runs ITutorPromptScrubber (FIND-privacy-008)
...
// Tutor seam; ADR-0047's generic IPiiPromptScrubber would be strictly weaker
// here. See TutorMessageService.BuildPromptAsync.
[TaskRouting("tier3", "socratic_question")]
[FeatureTag("socratic")]
[PiiPreScrubbed("TutorPromptScrubber (FIND-privacy-008) runs upstream in TutorMessageService.BuildPromptAsync with per-student StudentPiiContext. That scrubber is stricter than the ADR-0047 baseline.")]
