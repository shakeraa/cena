...
const relativeUpdated = computed(() => {
  ...
  if (diffMin < 60)
    return t('tutor.threadList.minutesAgo', { count: diffMin }, { plural: diffMin })
  if (diffHour < 24)
    return t('tutor.threadList.hoursAgo', { count: diffHour }, { plural: diffHour })

  return t('tutor.threadList.daysAgo', { count: diffDay }, { plural: diffDay })
})
</script>
    ...
    <div class="d-flex align-center">
      ...
      <div class="flex-grow-1 min-w-0">
        ...
        <div class="d-flex align-center text-caption text-medium-emphasis mt-1">
          ...
          <span>{{ t('tutor.threadList.messageCount', { count: thread.messageCount }, { plural: thread.messageCount }) }}</span>
