# TASK-PRR-017: Store Mashov credentials in secret manager + rotation runbook

**Priority**: P1 — strongly recommended before launch (lens consensus: 3)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-privacy, persona-sre, persona-redteam
**Source docs**: `AXIS_10_Operational_Integration_Features.md:L163`, `AXIS_10_Operational_Integration_Features.md:L83`
**Assignee hint**: kimi-coder
**Tags**: source=pre-release-review-2026-04-20, lens=sre
**Status**: Not Started
...
## Goal
Move Mashov credentials to secret manager (Vault/GSM). Document rotation runbook. No plaintext in config.

## Files
- deploy/helm/cena/values*.yaml
- ops/runbooks/mashov-credential-rotation.md

## Definition of Done
- Creds fetched from secret manager at boot; rotation tested; scanner rejects plaintext creds.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-017)
