# TASK-PRR-333: Parent visibility surface for mock-exam results (opt-in; ADR-0050 13+ default-hidden)
...
**Tags**: source=exam-prep-perfect-gap-2026-04-29,epic=epic-prr-n,backend-frontend
**Status**: Ready
...
Parent visibility surface for mock-exam results (opt-in; ADR-0050 13+ default-hidden).
