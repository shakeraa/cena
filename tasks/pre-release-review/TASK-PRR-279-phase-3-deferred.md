# TASK-PRR-279: Unit test: BagrutPaperStructureCatalog.UpsertSeedStructuresAsync idempotency

**Priority**: low
**Effort**: S-M
**Source docs**: claude-code Phase 3 self-audit 2026-04-29 (mock-exam runner SHOULD-FILE list).
**Assignee hint**: unassigned
**Tags**: source=exam-prep-phase-3-deferred,epic=epic-prr-n,test
**Status**: Ready
...
Close the test gap from Phase 3 of the mock-exam runner audit.
