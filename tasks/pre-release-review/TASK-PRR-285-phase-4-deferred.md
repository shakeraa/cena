# TASK-PRR-285: Photo-of-paper input mode for runner (PWA camera + OCR pipeline)
...
**Tags**: source=exam-prep-phase-4-deferred,epic=epic-prr-n,backend-frontend
**Status**: Ready
...
Close the backend-frontend gap from Phase 4 of the mock-exam runner audit — these are the items I called out honestly as still missing from the production-grade ship.
