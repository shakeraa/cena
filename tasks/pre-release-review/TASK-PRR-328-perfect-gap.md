# TASK-PRR-328: ExamTarget.QuestionPaperCodes binding to runner entry (default from onboarding)
...
**Tags**: source=exam-prep-perfect-gap-2026-04-29,epic=epic-prr-n,frontend-backend
**Status**: Ready
...
ExamTarget.QuestionPaperCodes binding to runner entry (default from onboarding).
