# TASK-PRR-147: Pre-release review close-out: publish tasks.jsonl to queue

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: S — 1-2 days
**Lens consensus**: persona-enterprise
**Source docs**: `SYNTHESIS.md`
...
## Goal
Ingest tasks.jsonl into .agentdb/kimi-queue.db with proper priority/assignee.

## Files
- scripts/queue/ingest-tasks-jsonl.js

## Definition of Done
- All 147 tasks enqueued; priorities preserved.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-147)
