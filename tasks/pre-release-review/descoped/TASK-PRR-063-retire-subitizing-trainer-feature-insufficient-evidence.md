# TASK-PRR-063: Retire subitizing trainer feature (insufficient evidence)
...
## Goal
Remove subitizing trainer from roadmap; evidence base too thin.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-063)
