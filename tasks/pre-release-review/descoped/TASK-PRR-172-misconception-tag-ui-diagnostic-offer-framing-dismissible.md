# TASK-PRR-172: Misconception tag UI: diagnostic-offer framing, dismissible

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-ethics
**Source docs**: `axis_6_assessment_feedback_research.md:L186`
**Assignee hint**: claude-subagent-policy
**Tags**: source=pre-release-review-2026-04-20, lens=ethics, origin=tight-match-audit, src-audit-id=O-074
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-074)
**Tier**: descoped
...
## Goal
Misconception tag UI: diagnostic-offer framing, dismissible

## Source
Raised by persona-ethics in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-074).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-172)
