# TASK-PRR-177: Retire idle-pulse animation in Stuck? Ask button

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-ethics
**Source docs**: `cena_competitive_analysis.md:L168`
**Assignee hint**: claude-subagent-policy
**Tags**: source=pre-release-review-2026-04-20, lens=ethics, origin=tight-match-audit, src-audit-id=O-085
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-085)
**Tier**: descoped
...
## Goal
Retire idle-pulse animation in Stuck? Ask button

## Source
Raised by persona-ethics in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-085).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-177)
