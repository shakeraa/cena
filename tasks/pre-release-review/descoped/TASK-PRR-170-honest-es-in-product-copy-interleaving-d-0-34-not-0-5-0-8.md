# TASK-PRR-170: Honest ES in product copy (Interleaving d=0.34, not 0.5-0.8)

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-finops
**Source docs**: `finding_assessment_dr_rami.md:L121`
**Assignee hint**: claude-subagent-finops
**Tags**: source=pre-release-review-2026-04-20, lens=finops, origin=tight-match-audit, src-audit-id=O-103
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-103)
**Tier**: descoped
...
## Goal
Honest ES in product copy (Interleaving d=0.34, not 0.5-0.8)

## Source
Raised by persona-finops in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-103).
...
## Reporting
complete via: node .agentdb/kimi-queue.js complete <id> --worker claude-subagent-finops --result "<branch>"
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-170)
