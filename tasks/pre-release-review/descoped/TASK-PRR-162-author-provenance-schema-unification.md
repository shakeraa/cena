# TASK-PRR-162: Author provenance schema unification

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-enterprise
**Source docs**: `AXIS_8_Content_Authoring_Quality_Research.md:L113`
**Assignee hint**: claude-code
**Tags**: source=pre-release-review-2026-04-20, lens=enterprise, origin=tight-match-audit, src-audit-id=O-060
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-060)
**Tier**: descoped

---

## Goal
Author provenance schema unification

## Source
Raised by persona-enterprise in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-060).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-162)
