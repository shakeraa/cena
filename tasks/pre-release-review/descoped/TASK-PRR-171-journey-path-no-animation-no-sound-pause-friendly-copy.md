# TASK-PRR-171: Journey path: no animation, no sound, pause-friendly copy

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-ethics
**Source docs**: `cena_cross_domain_feature_innovation.md:L238`
**Assignee hint**: claude-subagent-policy
**Tags**: source=pre-release-review-2026-04-20, lens=ethics, origin=tight-match-audit, src-audit-id=O-089
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-089)
**Tier**: descoped
...
## Goal
Journey path: no animation, no sound, pause-friendly copy

## Source
Raised by persona-ethics in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-089).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-171)
