# TASK-PRR-185: Transparency report: add banned-mechanic compliance section

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-ethics
**Source docs**: `axis9_data_privacy_trust_mechanics.md:L132`
**Assignee hint**: claude-subagent-policy
**Tags**: source=pre-release-review-2026-04-20, lens=ethics, origin=tight-match-audit, src-audit-id=O-072
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-072)
**Tier**: descoped
...
## Goal
Transparency report: add banned-mechanic compliance section

## Source
Raised by persona-ethics in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-072).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-185)
