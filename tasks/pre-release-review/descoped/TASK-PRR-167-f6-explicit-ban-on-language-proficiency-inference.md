# TASK-PRR-167: F6 explicit ban on language-proficiency inference

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-ethics
**Source docs**: `axis_8_content_authoring_quality_research.md:L159`
**Assignee hint**: claude-subagent-policy
**Tags**: source=pre-release-review-2026-04-20, lens=ethics, origin=tight-match-audit, src-audit-id=O-079
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-079)
**Tier**: descoped
...
## Goal
F6 explicit ban on language-proficiency inference

## Source
Raised by persona-ethics in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-079).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-167)
