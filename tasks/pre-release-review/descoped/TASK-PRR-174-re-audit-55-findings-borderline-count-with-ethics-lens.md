# TASK-PRR-174: Re-audit 55 findings BORDERLINE count with ethics lens

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-ethics
**Source docs**: `feature-discovery-2026-04-20.md:L125`
**Assignee hint**: claude-subagent-policy
**Tags**: source=pre-release-review-2026-04-20, lens=ethics, origin=tight-match-audit, src-audit-id=O-093
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-093)
**Tier**: descoped

---

## Goal
Re-audit 55 findings BORDERLINE count with ethics lens

## Source
Raised by persona-ethics in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-093).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-174)
