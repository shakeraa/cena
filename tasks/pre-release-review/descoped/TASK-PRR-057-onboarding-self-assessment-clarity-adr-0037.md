# TASK-PRR-057: Onboarding self-assessment clarity (ADR-0037)

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: S — 1-2 days
**Lens consensus**: persona-cogsci, persona-a11y
...
## Goal
Simplify onboarding self-assessment wording for ADR-0037 affective signal; AA contrast.

## Files
- src/student/full-version/src/views/onboarding/**

## Definition of Done
- Readability grade 5-6; contrast AA; analytics tag.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-057)
