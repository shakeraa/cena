# TASK-PRR-175: Re-bucket 'Top-10 Quick Wins' by evidence-quality tier

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-cogsci
**Source docs**: `feature-discovery-2026-04-20.md:L161`
**Assignee hint**: claude-subagent-pedagogy
**Tags**: source=pre-release-review-2026-04-20, lens=cogsci, origin=tight-match-audit, src-audit-id=O-033
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-033)
**Tier**: descoped

---

## Goal
Re-bucket 'Top-10 Quick Wins' by evidence-quality tier

## Source
Raised by persona-cogsci in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-033).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-175)
