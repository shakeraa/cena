# TASK-PRR-166: F3 rubric review: 'how this scored' framing, not 'lost points'

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-ethics
**Source docs**: `axis_8_content_authoring_quality_research.md:L179`
**Assignee hint**: claude-subagent-policy
**Tags**: source=pre-release-review-2026-04-20, lens=ethics, origin=tight-match-audit, src-audit-id=O-080
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-080)
**Tier**: descoped
...
## Goal
F3 rubric review: 'how this scored' framing, not 'lost points'

## Source
Raised by persona-ethics in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-080).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-166)
