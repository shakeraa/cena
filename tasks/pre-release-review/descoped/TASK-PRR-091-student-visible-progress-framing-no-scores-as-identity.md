# TASK-PRR-091: Student-visible progress framing (no scores-as-identity)
...
## Goal
Copy audit: avoid language conflating score with identity ('you are strong at X' → 'you solved 5 X-problems today').

## Files
- locale files

## Definition of Done
- Ship-gate clean; 3-language review.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-091)
