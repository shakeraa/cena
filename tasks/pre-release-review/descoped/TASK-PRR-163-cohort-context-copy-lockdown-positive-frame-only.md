# TASK-PRR-163: Cohort-context copy lockdown: positive-frame only

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-ethics
**Source docs**: `axis_4_parent_engagement_cena_research.md:L204`
**Assignee hint**: claude-subagent-policy
**Tags**: source=pre-release-review-2026-04-20, lens=ethics, origin=tight-match-audit, src-audit-id=O-073
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-073)
**Tier**: descoped
...
## Goal
Cohort-context copy lockdown: positive-frame only

## Source
Raised by persona-ethics in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-073).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-163)
