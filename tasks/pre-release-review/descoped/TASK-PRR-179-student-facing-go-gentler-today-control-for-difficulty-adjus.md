# TASK-PRR-179: Student-facing 'go gentler today' control for difficulty adjuster

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-ethics
**Source docs**: `axis1_pedagogy_mechanics_cena.md:L155`
**Assignee hint**: claude-subagent-policy
**Tags**: source=pre-release-review-2026-04-20, lens=ethics, origin=tight-match-audit, src-audit-id=O-067
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-067)
**Tier**: descoped
...
## Goal
Student-facing 'go gentler today' control for difficulty adjuster

## Source
Raised by persona-ethics in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-067).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-179)
