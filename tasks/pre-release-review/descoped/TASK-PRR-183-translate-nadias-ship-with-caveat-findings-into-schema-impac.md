# TASK-PRR-183: Translate Nadia's SHIP-with-caveat findings into schema impact list

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-enterprise
**Source docs**: `cena_dr_nadia_pedagogical_review_20_findings.md:L41`
**Assignee hint**: claude-code
**Tags**: source=pre-release-review-2026-04-20, lens=enterprise, origin=tight-match-audit, src-audit-id=O-065
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-065)
**Tier**: descoped

---

## Goal
Translate Nadia's SHIP-with-caveat findings into schema impact list

## Source
Raised by persona-enterprise in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-065).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-183)
