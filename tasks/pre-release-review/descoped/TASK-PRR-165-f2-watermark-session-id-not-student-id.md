# TASK-PRR-165: F2 watermark: session-id not student-id

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-ethics
**Source docs**: `axis_7_collaboration_social_features_cena.md:L289`
**Assignee hint**: claude-subagent-policy
**Tags**: source=pre-release-review-2026-04-20, lens=ethics, origin=tight-match-audit, src-audit-id=O-077
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-077)
**Tier**: descoped
...
## Goal
F2 watermark: session-id not student-id

## Source
Raised by persona-ethics in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-077).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-165)
