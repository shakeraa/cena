# TASK-PRR-169: Formalize 'intrinsic motivation risk map' as design-review tool

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-ethics
**Source docs**: `cena_dr_nadia_pedagogical_review_20_findings.md:L88`
**Assignee hint**: claude-subagent-policy
**Tags**: source=pre-release-review-2026-04-20, lens=ethics, origin=tight-match-audit, src-audit-id=O-091
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-091)
**Tier**: descoped
...
## Goal
Formalize 'intrinsic motivation risk map' as design-review tool

## Source
Raised by persona-ethics in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-091).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-169)
