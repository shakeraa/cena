# TASK-PRR-176: Retire 'new heatmap' proposal — extend existing projection

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-enterprise
**Source docs**: `cena_axis5_teacher_workflow_features.md:L112`
**Assignee hint**: claude-code
**Tags**: source=pre-release-review-2026-04-20, lens=enterprise, origin=tight-match-audit, src-audit-id=O-064
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-064)
**Tier**: descoped

---

## Goal
Retire 'new heatmap' proposal — extend existing projection

## Source
Raised by persona-enterprise in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-064).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-176)
