# TASK-PRR-168: Focus-ritual mood-adjustment copy: 'familiar pattern' not 'easier'

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-educator
**Source docs**: `cena_cross_domain_feature_innovation.md:L185`
**Assignee hint**: claude-subagent-pedagogy
**Tags**: source=pre-release-review-2026-04-20, lens=educator, origin=tight-match-audit, src-audit-id=O-049
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-049)
**Tier**: descoped
...
## Goal
Focus-ritual mood-adjustment copy: 'familiar pattern' not 'easier'

## Source
Raised by persona-educator in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-049).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-168)
