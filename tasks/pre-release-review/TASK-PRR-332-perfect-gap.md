# TASK-PRR-332: Onboarding flow — "first run" tutorial overlay for new exam-prep users
...
**Tags**: source=exam-prep-perfect-gap-2026-04-29,epic=epic-prr-n,frontend
**Status**: Ready
...
Onboarding flow — "first run" tutorial overlay for new exam-prep users.
