# TASK-PRR-043: ADR: Companion-bot / therapy-scope boundary

**Priority**: P1 — strongly recommended before launch (lens consensus: 2)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-ethics, persona-redteam
**Source docs**: `cena_cross_domain_feature_innovation.md:L~`
...
## Goal
ADR on scope limits for Cena Companion / wellness bot: no therapy framing, safeguarding escalation path, crisis-keyword handoff.

## Files
- docs/adr/NNNN-companion-bot-scope.md

## Definition of Done
- ADR accepted; escalation workflow documented.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-043)
