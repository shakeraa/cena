# TASK-PRR-269: ADR-0059 R5 Browse-history scope-limitation (5 controls per ADR-0059 §15.6)

**Priority**: P1
**Effort**: M (2-4 days)
**Source docs**: ADR-0059 §14.4, claude-code self-audit 2026-04-29 (deferred-task filing)
**Assignee hint**: unassigned
**Tags**: source=adr-0059-deferred,epic=epic-prr-n,priority=p1,privacy
**Status**: Ready
...
Close the R5 Browse-history scope-limitation (5 controls per ADR-0059 §15.6) gap from ADR-0059 §14.4. The mock-exam runner (exam-prep slice) is shipping in parallel; this task is the wrapper-rollout side that gates flag-flip on legal sign-off (PRR-249).
