# TASK-PRR-322: Cost telemetry per mock-exam run with $-projection on admin dashboard
...
**Tags**: source=exam-prep-perfect-gap-2026-04-29,epic=epic-prr-n,ops
**Status**: Ready
...
Cost telemetry per mock-exam run with $-projection on admin dashboard.
