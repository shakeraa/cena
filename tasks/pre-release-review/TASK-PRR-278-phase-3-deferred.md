# TASK-PRR-278: Retry on transient 5xx in getMockExamRunResult

**Priority**: low
**Effort**: S-M
**Source docs**: claude-code Phase 3 self-audit 2026-04-29 (mock-exam runner SHOULD-FILE list).
**Assignee hint**: unassigned
**Tags**: source=exam-prep-phase-3-deferred,epic=epic-prr-n,frontend
**Status**: Ready
...
Close the frontend gap from Phase 3 of the mock-exam runner audit.
