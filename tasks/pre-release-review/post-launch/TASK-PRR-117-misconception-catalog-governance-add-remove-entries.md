# TASK-PRR-117: Misconception catalog governance (add/remove entries)

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: S — 1-2 days
**Lens consensus**: persona-educator, persona-cogsci
**Source docs**: `AXIS_6_Assessment_Feedback_Research.md:L~`
...
## Goal
Formal governance for MisconceptionCatalog entries (add/deprecate).

## Files
- content authoring process doc

## Definition of Done
- Process documented; reviewers assigned.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-117)
