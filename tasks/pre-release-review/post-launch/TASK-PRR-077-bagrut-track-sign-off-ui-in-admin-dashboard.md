# TASK-PRR-077: Bagrut-track sign-off UI in admin dashboard

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-ministry, persona-educator
**Source docs**: `cena_axis5_teacher_workflow_features.md:L160`
...
## Goal
Admin UI to sign off on Bagrut items by track (3/4/5 unit), version-pinned.

## Files
- src/admin/full-version/src/views/bagrut-signoff/**

## Definition of Done
- UI live; artifact exportable.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-077)
