# TASK-PRR-116: Rate-limit: admin bulk endpoints

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: S — 1-2 days
**Lens consensus**: persona-sre, persona-redteam
...
## Goal
Add rate-limits on admin bulk endpoints (roster import, export).

## Files
- admin API

## Definition of Done
- Limits enforced; tests.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-116)
