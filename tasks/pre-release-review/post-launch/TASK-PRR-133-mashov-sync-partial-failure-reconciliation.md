# TASK-PRR-133: Mashov sync: partial-failure reconciliation

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-sre, persona-educator
...
## Goal
Reconcile partial-failure Mashov sync (some students synced, others failed).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-133)
