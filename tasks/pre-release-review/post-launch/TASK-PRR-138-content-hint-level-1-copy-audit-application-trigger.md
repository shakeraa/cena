# TASK-PRR-138: Content: hint-level 1 copy audit (application-trigger)
...
## Goal
Audit all L1 hints to ensure they are conceptual pointers, not formulas.

## Files
- hint content store

## Definition of Done
- Audit complete; flagged items re-authored.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-138)
