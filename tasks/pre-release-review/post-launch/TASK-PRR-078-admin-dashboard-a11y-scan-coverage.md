# TASK-PRR-078: Admin-dashboard A11y scan coverage
...
## Goal
Extend axe-core to admin/full-version views; fix AA violations.

## Files
- src/admin/full-version/tests/a11y/**

## Definition of Done
- Scan green on primary admin pages.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-078)
