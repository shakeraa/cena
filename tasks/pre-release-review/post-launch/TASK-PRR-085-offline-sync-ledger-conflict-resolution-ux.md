# TASK-PRR-085: Offline sync ledger conflict resolution UX

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-enterprise, persona-educator
**Source docs**: `AXIS_10_Operational_Integration_Features.md:L~`
...
## Goal
Surface offline-sync conflicts to users with plain-language resolution choices.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-085)
