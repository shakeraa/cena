# TASK-PRR-059: ADR: Minimum-anonymity (k≥10) as platform primitive
...
## Goal
ADR locking k≥10 floor across the platform; all violation sites catalogued.

## Files
- docs/adr/NNNN-k-anonymity-floor.md
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-059)
