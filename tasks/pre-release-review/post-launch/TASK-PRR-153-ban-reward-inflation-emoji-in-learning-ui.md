# TASK-PRR-153: Ban reward-inflation emoji (🔥, ⚡) in learning UI

**Priority**: P1 — strongly-recommended pre-launch (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-ethics
**Source docs**: `cena_cross_domain_feature_innovation.md:L179`
**Assignee hint**: claude-subagent-policy
**Tags**: source=pre-release-review-2026-04-20, lens=ethics, origin=tight-match-audit, src-audit-id=O-086
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-086)
**Tier**: post-launch
...
## Goal
Ban reward-inflation emoji (🔥, ⚡) in learning UI

## Source
Raised by persona-ethics in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-086).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-153)
