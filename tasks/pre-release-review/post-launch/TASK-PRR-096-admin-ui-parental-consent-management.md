# TASK-PRR-096: Admin UI: parental-consent management

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-privacy, persona-enterprise
...
## Goal
Admin UI for managing parental consent per purpose and child.

## Files
- src/admin/full-version/src/views/consent/**
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-096)
