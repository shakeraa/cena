# TASK-PRR-062: Admin audit-log for privileged actions (roster change, grade override)
...
## Goal
Immutable audit-log for privileged admin/teacher actions; exportable.

## Files
- src/actors/Cena.Actors/Compliance/AuditLog.cs

## Definition of Done
- Append-only store; viewer; retention policy.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-062)
