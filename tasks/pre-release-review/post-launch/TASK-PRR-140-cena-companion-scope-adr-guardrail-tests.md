# TASK-PRR-140: Cena Companion scope ADR + guardrail tests
...
## Goal
ADR + guardrail arch tests for Cena Companion bot.

## Files
- docs/adr/NNNN-companion-bot-guardrails.md
- tests

## Definition of Done
- Tests verify no therapy framing, crisis handoff exists.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-140)
