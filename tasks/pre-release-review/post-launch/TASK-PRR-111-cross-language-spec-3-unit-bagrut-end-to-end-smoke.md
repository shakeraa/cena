# TASK-PRR-111: Cross-language spec: 3-unit-Bagrut end-to-end smoke
...
## Goal
E2E smoke test covering Hebrew 3-unit Bagrut learning path.

## Files
- tests/e2e/bagrut-3-unit.spec.ts
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-111)
