# TASK-PRR-086: Device fingerprint purge on account deletion
...
## Goal
Delete device fingerprints on account erasure; close a leftover-data gap.

## Files
- RetentionWorker

## Definition of Done
- Verified via e2e; audit row.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-086)
