# TASK-PRR-118: Opt-in analytics consent gate (student-web)
...
## Goal
No analytics until explicit opt-in; default OFF.

## Files
- student-web analytics SDK
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-118)
