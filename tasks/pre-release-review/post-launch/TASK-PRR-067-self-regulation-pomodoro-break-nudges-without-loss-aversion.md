# TASK-PRR-067: Self-regulation: pomodoro/break nudges without loss aversion
...
## Goal
Add break nudges using positive framing (no streak loss language).

## Files
- student-web notifications

## Definition of Done
- Copy ship-gate clean; tested.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-067)
