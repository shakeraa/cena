# TASK-PRR-097: Student-web error boundary + Sentry wiring
...
## Goal
Top-level error boundary; Sentry project; PII scrubbing in error payloads.

## Files
- src/student/full-version/src/App.vue

## Definition of Done
- Errors captured; PII scrubbed; runbook.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-097)
