# TASK-PRR-134: Student progress export (self-service, PDF)

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: S — 1-2 days
**Lens consensus**: persona-educator, persona-privacy
...
## Goal
Student can export progress summary as PDF; no theta scalar.

## Files
- student-web

## Definition of Done
- PDF generated; RDY-080 clean.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-134)
