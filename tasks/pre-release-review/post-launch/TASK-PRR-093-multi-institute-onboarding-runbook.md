# TASK-PRR-093: Multi-institute onboarding runbook
...
## Goal
Ops runbook for onboarding new institute (tenant, SSO, Mashov creds, retention).

## Files
- ops/runbooks/institute-onboarding.md

## Definition of Done
- Runbook committed; rehearsed.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-093)
