# TASK-PRR-072: Item bank coverage matrix vs Bagrut syllabus
...
## Goal
Coverage matrix mapping items to Bagrut syllabus cells; expose gaps to content authoring.

## Files
- docs/content/coverage-matrix.md

## Definition of Done
- Matrix current; gap list ticketed.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-072)
