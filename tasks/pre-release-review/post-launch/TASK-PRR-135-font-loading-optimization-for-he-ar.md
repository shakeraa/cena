# TASK-PRR-135: Font loading optimization for he/ar

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: S — 1-2 days
**Lens consensus**: persona-a11y, persona-sre
...
## Goal
Sub-resource font hints + swap to reduce CLS on Hebrew/Arabic.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-135)
