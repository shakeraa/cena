# TASK-PRR-090: Teacher-override workflow for CAS-fail items
...
## Goal
Teacher can appeal CAS-fail verdict with reviewer sign-off; audit.

## Files
- admin UI; backend

## Definition of Done
- Flow exercised; audit row.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-090)
