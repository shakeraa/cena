# TASK-PRR-055: Ethics review checklist template for new features
...
## Goal
Checklist template (dark-pattern, consent, age-band, PII, evidence) required on every new feature PR.
...
## Definition of Done
- Template committed; used on next 3 PRs.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-055)
