# TASK-PRR-137: Admin: Emulator session replay for support
...
## Goal
Emulator replay of student session for support debugging (PII-scrubbed).

## Files
- emulator service + admin UI

## Definition of Done
- Replay works; PII scrubbed.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-137)
