# TASK-PRR-184: Translation review gate for therapy/medical language (FD-017)
...
**Assignee hint**: claude-subagent-a11y
**Tags**: source=pre-release-review-2026-04-20, lens=a11y, origin=tight-match-audit, src-audit-id=O-017
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-017)
**Tier**: post-launch

---

## Goal
Translation review gate for therapy/medical language (FD-017)

## Source
Raised by persona-a11y in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-017).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-184)
