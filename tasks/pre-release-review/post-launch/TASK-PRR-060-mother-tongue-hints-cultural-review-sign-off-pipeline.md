# TASK-PRR-060: Mother-tongue hints: cultural-review sign-off pipeline

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-educator, persona-ministry
**Source docs**: `AXIS_8_Content_Authoring_Quality_Research.md:L~`
...
## Goal
Mother-tongue hint text must pass cultural-review board before display; versioned.

## Files
- src/actors/Cena.Actors/ContentAuthoring/**

## Definition of Done
- Pipeline live; sign-off artifacts stored.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-060)
