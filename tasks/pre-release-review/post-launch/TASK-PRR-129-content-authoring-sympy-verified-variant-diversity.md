# TASK-PRR-129: Content authoring: sympy-verified variant diversity
...
## Goal
Variant diversity metric (symbolic distance) gated on CAS.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-129)
