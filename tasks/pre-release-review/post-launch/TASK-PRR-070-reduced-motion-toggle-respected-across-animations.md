# TASK-PRR-070: Reduced-motion toggle respected across animations
...
## Goal
Ensure prefers-reduced-motion is honored in all student-web/admin animations.

## Files
- src/student/full-version/src/**

## Definition of Done
- Axe test; visual regression.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-070)
