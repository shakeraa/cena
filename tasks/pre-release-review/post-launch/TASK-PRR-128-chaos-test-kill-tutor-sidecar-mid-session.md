# TASK-PRR-128: Chaos-test: kill tutor sidecar mid-session
...
## Goal
Chaos test: kill tutor sidecar, verify graceful degrade.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-128)
