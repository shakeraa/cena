# TASK-PRR-115: Tutor safety guard: red-team prompt-injection canaries
...
## Goal
Expand TutorSafetyGuard tests with prompt-injection canary suite.

## Files
- tests/security/tutor-prompt-injection.spec.ts

## Definition of Done
- Canaries caught; regression tests.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-115)
