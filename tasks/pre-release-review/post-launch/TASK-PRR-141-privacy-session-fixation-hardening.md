# TASK-PRR-141: Privacy: session fixation hardening
...
## Goal
Regenerate session ID on auth; invalidate pre-auth session; tests.

## Files
- auth middleware

## Definition of Done
- Tests verify fixation closed.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-141)
