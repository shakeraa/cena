# TASK-PRR-143: Observability: trace id on every LLM call
...
## Goal
Propagate trace-id into every LLM call; correlate with cost + tenant + feature.

## Files
- LLM client

## Definition of Done
- Trace-id in logs; dashboard.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-143)
