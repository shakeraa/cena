# TASK-PRR-108: WhatsApp Twilio adapter opt-out enforcement

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: S — 1-2 days
**Lens consensus**: persona-privacy, persona-ethics
**Source docs**: `AXIS_4_Parent_Engagement_Cena_Research.md:L109`
...
## Goal
Enforce Twilio STOP keyword and local opt-out state; never overwrite.

## Files
- src/actors/Cena.Actors/Messaging/WhatsApp/**
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-108)
