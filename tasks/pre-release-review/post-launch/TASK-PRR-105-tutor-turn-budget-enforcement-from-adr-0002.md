# TASK-PRR-105: Tutor turn-budget enforcement from ADR-0002
...
## Goal
Enforce turn-budget cap per tutor session (from ADR-0002); 429 on breach; fallback to non-LLM hint.

## Files
- tutor actor

## Definition of Done
- Cap hit behavior tested.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-105)
