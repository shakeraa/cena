# TASK-PRR-066: Retrieval prompt reframe: formulas → application triggers
...
## Goal
Rewrite retrieval micro-check prompts to target application triggers, not formula recall.

## Files
- content authoring prompts

## Definition of Done
- Prompts updated; sampled review.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-066)
