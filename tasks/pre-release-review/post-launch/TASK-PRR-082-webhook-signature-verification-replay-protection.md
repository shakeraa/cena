# TASK-PRR-082: Webhook signature verification + replay protection
...
## Goal
All inbound webhooks verify HMAC + nonce/timestamp replay window.

## Files
- src/shared/Cena.Infrastructure/Webhooks/**
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-082)
