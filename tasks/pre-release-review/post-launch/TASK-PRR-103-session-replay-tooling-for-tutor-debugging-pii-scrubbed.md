# TASK-PRR-103: Session replay tooling for tutor debugging (PII-scrubbed)

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-sre, persona-privacy
**Source docs**: `cena_competitive_analysis.md:L~`
...
## Goal
Tutor session replay for debug; PII scrubbed; retention ≤7d.

## Files
- src/actors/Cena.Actors/Tutor/ReplayStore.cs

## Definition of Done
- PII scrubbed; retention enforced; access audited.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-103)
