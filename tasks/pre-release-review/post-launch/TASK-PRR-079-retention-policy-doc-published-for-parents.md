# TASK-PRR-079: Retention-policy doc published for parents
...
## Goal
Public-facing retention policy doc; lists categories, TTLs, erasure path.

## Files
- docs/privacy/retention-policy.md

## Definition of Done
- Published; parent-accessible.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-079)
