# TASK-PRR-112: Admin UI: cost per feature per cohort

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-finops, persona-enterprise
...
## Goal
Admin cost dashboard by feature and cohort.

## Files
- admin dashboards

## Definition of Done
- Dashboard live; exports.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-112)
