# TASK-PRR-122: Reference-only Ministry corpus read path hardening
...
## Goal
Harden read path: Ministry corpus is reference-only, never exposed to student items.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-122)
