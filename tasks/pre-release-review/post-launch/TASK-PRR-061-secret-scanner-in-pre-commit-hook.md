# TASK-PRR-061: Secret scanner in pre-commit hook
...
## Goal
Add trufflehog/gitleaks pre-commit + CI; blocks known secret patterns.
...
## Definition of Done
- Hook + CI green; canary secret blocked.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-061)
