# TASK-PRR-109: Admin: export misconception catalog (internal)
...
## Goal
Internal admin export of MisconceptionCatalog (not student-linked) for curriculum team.

## Files
- admin UI

## Definition of Done
- Export works; only aggregate catalog, no session data.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-109)
