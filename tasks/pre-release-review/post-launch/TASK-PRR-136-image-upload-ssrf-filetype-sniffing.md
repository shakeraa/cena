# TASK-PRR-136: Image-upload SSRF + filetype sniffing
...
## Goal
Image upload: SSRF + content sniff + magic-byte check.

## Files
- photo ingest service

## Definition of Done
- Canaries rejected; tests.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-136)
