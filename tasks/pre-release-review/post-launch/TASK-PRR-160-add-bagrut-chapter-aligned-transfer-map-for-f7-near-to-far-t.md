# TASK-PRR-160: Add Bagrut-chapter-aligned transfer map for F7 near-to-far transfer

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-ministry
**Source docs**: `axis1_pedagogy_mechanics_cena.md:L138`
**Assignee hint**: claude-subagent-policy
**Tags**: source=pre-release-review-2026-04-20, lens=ministry, origin=tight-match-audit, src-audit-id=O-105
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-105)
**Tier**: post-launch

---

## Goal
Add Bagrut-chapter-aligned transfer map for F7 near-to-far transfer

## Source
Raised by persona-ministry in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-105).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-160)
