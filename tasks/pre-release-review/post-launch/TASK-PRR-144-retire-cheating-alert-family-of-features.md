# TASK-PRR-144: Retire 'cheating alert' family of features

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: S — 1-2 days
**Lens consensus**: persona-ethics, persona-educator
...
## Goal
Retire cheating-detection proposals; replace with positive academic-integrity framing + teacher-initiated review.

## Files
- roadmap; retired.md

## Definition of Done
- Feature removed; rationale captured.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-144)
