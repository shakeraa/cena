# TASK-PRR-065: Strategy-discrimination scores in AdaptiveScheduler (session-scoped)

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-educator, persona-cogsci
**Source docs**: `axis1_pedagogy_mechanics_cena.md:L46`
...
## Goal
Extend AdaptiveScheduler with per-skill-pair strategy-discrimination scores; session-scoped; session-only weighting of interleave mix.

## Files
- src/actors/Cena.Actors/Mastery/AdaptiveScheduler.cs
- src/actors/Cena.Actors/Mastery/ItemSelector.cs

## Definition of Done
- No SQL persistence under StudentState; tests; integration through LearningSessionActor.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-065)
