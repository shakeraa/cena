# TASK-PRR-094: LocaleInference privacy: no IP retention
...
## Goal
Confirm IP used only in-memory for locale inference; no persistence.

## Files
- locale inference backend
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-094)
