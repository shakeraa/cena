# TASK-PRR-054: Saga timeout + compensation for peer collab sessions
...
## Goal
Timeouts + compensation for peer collab sagas; stuck sessions auto-close after TTL.

## Files
- src/actors/Cena.Actors/Collaboration/**

## Definition of Done
- TTL honored; compensation tested.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-054)
