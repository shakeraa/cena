# TASK-PRR-173: Pre-problem retrieval prompts (F3) as session-local low-stakes recall

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-cogsci
**Source docs**: `axis1_pedagogy_mechanics_cena.md:L157`
**Assignee hint**: claude-subagent-pedagogy
**Tags**: source=pre-release-review-2026-04-20, lens=cogsci, origin=tight-match-audit, src-audit-id=O-023
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-023)
**Tier**: post-launch
...
## Goal
Pre-problem retrieval prompts (F3) as session-local low-stakes recall

## Source
Raised by persona-cogsci in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-023).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-173)
