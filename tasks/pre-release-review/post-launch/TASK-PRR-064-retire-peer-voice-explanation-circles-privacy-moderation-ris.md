# TASK-PRR-064: Retire peer voice-explanation circles (privacy/ moderation risk)
...
## Goal
Remove voice-based peer explanation circles; moderation/PII risk outweighs benefit.

## Files
- docs/roadmap/**

## Definition of Done
- Feature removed; rationale captured in retired.md.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-064)
