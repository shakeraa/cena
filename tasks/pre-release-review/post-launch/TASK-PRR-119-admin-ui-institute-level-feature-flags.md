# TASK-PRR-119: Admin UI: institute-level feature flags
...
## Goal
Enable/disable features per institute from admin UI.

## Files
- admin UI; backend flag service
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-119)
