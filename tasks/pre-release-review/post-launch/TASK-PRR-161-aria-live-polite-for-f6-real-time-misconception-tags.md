# TASK-PRR-161: aria-live='polite' for F6 real-time misconception tags

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-a11y
**Source docs**: `axis_6_assessment_feedback_research.md:L97`
**Assignee hint**: claude-subagent-a11y
**Tags**: source=pre-release-review-2026-04-20, lens=a11y, origin=tight-match-audit, src-audit-id=O-009
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-009)
**Tier**: post-launch

---

## Goal
aria-live='polite' for F6 real-time misconception tags

## Source
Raised by persona-a11y in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-009).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-161)
