# TASK-PRR-068: Goal-setting UI: SMART frame, no gamified metaphors

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: S — 1-2 days
**Lens consensus**: persona-educator, persona-ethics
...
## Goal
Reframe goal-setting as SMART goals; drop XP/level metaphors.

## Files
- student-web goals view
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-068)
