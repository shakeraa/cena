# TASK-PRR-181: Throttle confidence check-ins to ≤1 per 5 problems, high-leverage only

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-educator
**Source docs**: `axis2_motivation_self_regulation_findings.md:L211`
**Assignee hint**: claude-subagent-pedagogy
**Tags**: source=pre-release-review-2026-04-20, lens=educator, origin=tight-match-audit, src-audit-id=O-044
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-044)
**Tier**: post-launch

---

## Goal
Throttle confidence check-ins to ≤1 per 5 problems, high-leverage only

## Source
Raised by persona-educator in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-044).
...
## Reporting
complete via: node .agentdb/kimi-queue.js complete <id> --worker claude-subagent-pedagogy --result "<branch>"
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-181)
