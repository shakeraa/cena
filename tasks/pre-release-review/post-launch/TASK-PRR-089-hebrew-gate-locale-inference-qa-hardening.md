# TASK-PRR-089: Hebrew gate + locale inference QA hardening
...
## Goal
Edge-case QA for Hebrew/Arabic locale inference (IP + browser); fallback rules.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-089)
