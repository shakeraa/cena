# TASK-PRR-126: Per-cohort content difficulty profile (IL 3/4/5 unit)
...
## Goal
Difficulty profile per Bagrut track; feeds EloDifficultyService.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-126)
