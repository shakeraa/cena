# TASK-PRR-074: Crisis keyword handoff path + school counselor escalation
...
## Goal
Safeguarding: crisis keyword detection → counselor escalation path; documented runbook.

## Files
- src/actors/Cena.Actors/Safeguarding/**

## Definition of Done
- Flow exercised; runbook; opt-in for institutes.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-074)
