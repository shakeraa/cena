# TASK-PRR-127: Teacher: mark-item-for-review one-click
...
## Goal
One-click 'flag item' from teacher view; goes to content QA queue.

## Files
- teacher view

## Definition of Done
- Button wired; queue entry.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-127)
