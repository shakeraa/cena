# TASK-PRR-139: Readme coverage for multi-agent coord protocol
...
## Goal
Doc coverage for multi-agent coordination protocol onboarding.

## Files
- AGENTS.md + .agentdb/QUEUE.md

## Definition of Done
- Docs updated; new-agent kickoff tested.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-139)
