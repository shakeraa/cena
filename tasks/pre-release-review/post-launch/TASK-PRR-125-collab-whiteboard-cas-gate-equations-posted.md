# TASK-PRR-125: Collab whiteboard: CAS-gate equations posted

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-ministry, persona-redteam
**Source docs**: `AXIS_7_Collaboration_Social_Features_Cena.md:L~`
...
## Goal
Equations drawn on collab whiteboard pass CAS before persist.

## Files
- collab whiteboard service
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-125)
