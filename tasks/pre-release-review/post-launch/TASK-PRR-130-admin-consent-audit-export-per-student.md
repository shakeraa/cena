# TASK-PRR-130: Admin: consent audit export per student
...
## Goal
Export consent history per student.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-130)
