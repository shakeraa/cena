# TASK-PRR-098: Admin roster bulk rollback + soft-delete

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-enterprise, persona-redteam
**Source docs**: `AXIS_10_Operational_Integration_Features.md:L135`
...
## Goal
Bulk roster imports support soft-delete + rollback in admin UI.

## Files
- admin roster-import feature

## Definition of Done
- Rollback tested; audit.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-098)
