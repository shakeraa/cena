# TASK-PRR-131: ADR: Cross-student saga pattern
...
## Goal
Formal ADR for saga pattern on cross-student flows.

## Files
- docs/adr/NNNN-cross-student-saga.md
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-131)
