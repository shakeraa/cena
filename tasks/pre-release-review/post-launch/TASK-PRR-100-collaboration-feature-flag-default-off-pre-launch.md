# TASK-PRR-100: Collaboration feature flag: default OFF pre-launch

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: S — 1-2 days
**Lens consensus**: persona-redteam, persona-sre
...
## Goal
All AXIS-7 collaboration features ship behind feature flag, default OFF until moderation/CAS-gate land.

## Files
- feature-flag config

## Definition of Done
- Flag wired; default OFF.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-100)
