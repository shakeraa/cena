# TASK-PRR-110: Classroom aggregate: 'not enough data' fallback UI

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: S — 1-2 days
**Lens consensus**: persona-privacy, persona-educator
**Source docs**: `cena_axis5_teacher_workflow_features.md:L63`
...
## Goal
When k<10, show 'not enough data yet' instead of hiding the widget.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-110)
