# TASK-PRR-084: Cost alert: LLM spend per institute breach
...
## Goal
Per-institute cost alert when LLM spend exceeds 2σ baseline.

## Files
- ops/prometheus/alerts-cost.yml
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-084)
