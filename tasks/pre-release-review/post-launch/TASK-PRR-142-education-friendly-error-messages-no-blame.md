# TASK-PRR-142: Education-friendly error messages (no blame)
...
## Goal
Rewrite error/validation strings to avoid blame/guilt framing.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-142)
