# TASK-PRR-092: ADR: Prediction-surface ban as architecture

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: S — 1-2 days
**Lens consensus**: persona-ministry, persona-ethics
**Source docs**: `AXIS_6_Assessment_Feedback_Research.md:L169`
...
## Goal
ADR formally adopting RDY-080 as architecture test (not copy rule).
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-092)
