# TASK-PRR-099: Locale-aware number/date format for Hebrew/Arabic
...
## Goal
Use locale-aware number/date format; tests.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-099)
