# TASK-PRR-114: Student self-service data-access log
...
## Goal
Student can view who accessed their data (teacher/admin) — date + purpose.

## Files
- student-web privacy view
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-114)
