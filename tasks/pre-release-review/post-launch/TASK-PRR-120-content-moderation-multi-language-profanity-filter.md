# TASK-PRR-120: Content moderation: multi-language profanity filter
...
## Goal
He/ar/en profanity filter on any UGC path; escalate to reviewer on hits.

## Files
- moderation service

## Definition of Done
- Filters verified; reviewer path.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-120)
