# TASK-PRR-056: UGC moderation queue DLQ + SLA

**Priority**: P2 — post-launch improvement (lens consensus: 2)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-sre, persona-ethics
...
## Goal
DLQ + SLA for user-generated-content moderation; stale items alerted.

## Files
- src/actors/Cena.Actors/Moderation/**

## Definition of Done
- DLQ wired; SLA metrics; runbook.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-056)
