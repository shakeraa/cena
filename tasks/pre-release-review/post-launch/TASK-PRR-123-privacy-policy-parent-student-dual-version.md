# TASK-PRR-123: Privacy policy: parent + student dual-version
...
## Goal
Publish parent-version and student-version (age-appropriate) privacy policies.

## Files
- docs/privacy/**

## Definition of Done
- Both published; 3 languages.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-123)
