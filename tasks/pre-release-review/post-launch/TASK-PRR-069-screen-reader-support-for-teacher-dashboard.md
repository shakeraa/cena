# TASK-PRR-069: Screen-reader support for teacher dashboard
...
## Goal
Full NVDA/VoiceOver support on teacher dashboard (tables, charts, filters).

## Files
- src/admin/full-version/src/views/teacher/**

## Definition of Done
- axe-core passes; screen-reader smoke test.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-069)
