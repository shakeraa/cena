# TASK-PRR-095: Runbook: LLM vendor outage failover
...
## Goal
Playbook for Anthropic outage: fall back to non-LLM scaffolding; messaging to students.

## Files
- ops/runbooks/llm-outage.md

## Definition of Done
- Runbook; tabletop exercised.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-095)
