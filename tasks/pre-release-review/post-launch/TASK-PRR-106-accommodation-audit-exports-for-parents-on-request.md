# TASK-PRR-106: Accommodation audit exports for parents (on request)
...
## Goal
Parents can request export of applied accommodations (what + when).

## Files
- admin UI

## Definition of Done
- Export works; audit row.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-106)
