# TASK-PRR-083: Teacher feedback widget (bug/content/accommodation)
...
## Goal
In-app feedback widget routed to triage; categorized.

## Files
- src/admin/full-version/src/components/feedback/**

## Definition of Done
- Widget live; tickets created.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-083)
