# TASK-PRR-080: Data-portability export (student self-service)

**Priority**: P2 — post-launch improvement (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-privacy
**Source docs**: `axis9_data_privacy_trust_mechanics.md:L~`
...
## Goal
Student self-service data-portability export (JSON + human-readable).

## Files
- src/student/full-version/src/views/privacy/**
- backend export

## Definition of Done
- Export complete; e2e test.
...
- [Canonical task JSON](../../../pre-release-review/reviews/tasks.jsonl) (id: prr-080)
