# TASK-PRR-004: Promote contracts/llm/routing-config.yaml governance to ADR-026 + CI scanner

**Priority**: P0 — ship-blocker (lens consensus: 5)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-finops, persona-enterprise, persona-sre, persona-cogsci, persona-redteam
...
## Goal
Author ADR-026 governing 3-tier routing (Booster/Haiku/Sonnet). Add CI scanner that fails any task defaulting to Sonnet without justification.

## Files
- docs/adr/0026-three-tier-model-routing.md
- scripts/ci/check-model-routing.sh

## Definition of Done
- ADR accepted; scanner wired into CI; silent-default-to-Sonnet breaks build.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-004)
