# TASK-PRR-286: Variant generation wired into runner (replace static seed pool with per-run variant draws)
...
**Tags**: source=exam-prep-phase-4-deferred,epic=epic-prr-n,backend
**Status**: Ready
...
Close the backend gap from Phase 4 of the mock-exam runner audit — these are the items I called out honestly as still missing from the production-grade ship.
