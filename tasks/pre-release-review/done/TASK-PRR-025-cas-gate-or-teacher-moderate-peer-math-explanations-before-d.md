# TASK-PRR-025: CAS-gate or teacher-moderate peer math explanations before delivery

**Priority**: P1 — strongly recommended before launch (lens consensus: 4)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-ministry, persona-redteam, persona-a11y, persona-educator
**Source docs**: `AXIS_7_Collaboration_Social_Features_Cena.md:L114`, `AXIS_7_Collaboration_Social_Features_Cena.md:L105`
...
## Goal
Route every peer-authored math explanation through CAS verification OR teacher-moderation queue before reaching another student.

## Files
- src/actors/Cena.Actors/Collaboration/PeerExplanationPipeline.cs
- CAS verify adapter; moderation queue

## Definition of Done
- Unverified explanations never delivered; moderation UI; tests.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-025)
