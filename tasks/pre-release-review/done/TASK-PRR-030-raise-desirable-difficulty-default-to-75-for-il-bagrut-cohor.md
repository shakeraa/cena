# TASK-PRR-030: Raise desirable-difficulty default to 75% for IL Bagrut cohort + ADR

**Priority**: P1 — strongly recommended before launch (lens consensus: 3)
**Effort**: S — 1-2 days
**Lens consensus**: persona-educator, persona-cogsci, persona-ethics
**Source docs**: `axis1_pedagogy_mechanics_cena.md:L210`, `axis1_pedagogy_mechanics_cena.md:L205`
...
## Goal
Shift desirable-difficulty default from 60% → 75% success rate. Author ADR explaining cohort-specific tuning.

## Files
- src/actors/Cena.Actors/Services/EloDifficultyService.cs
- docs/adr/NNNN-desirable-difficulty-targets.md

## Definition of Done
- Default 0.75; confidence-mode 0.85 pre-Bagrut; ADR accepted.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-030)
