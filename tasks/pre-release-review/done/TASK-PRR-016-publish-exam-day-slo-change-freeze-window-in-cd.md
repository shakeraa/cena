# TASK-PRR-016: Publish exam-day SLO + change-freeze window in CD

**Priority**: P1 — strongly recommended before launch (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-sre
**Source docs**: `feature-discovery-2026-04-20.md:L91`, `AXIS_6_Assessment_Feedback_Research.md:L72`
...
## Goal
Publish exam-day SLO (per host + platform) and implement CD change-freeze window around Bagrut exam weeks.

## Files
- ops/slo/exam-day.yaml
- deploy/helm/cena/freeze-window.yaml

## Definition of Done
- SLO dashboard live; freeze gates deployments during window; runbook.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-016)
