# TASK-PRR-023: Saga/process-manager pattern for cross-student collaboration flows

**Priority**: P1 — strongly recommended before launch (lens consensus: 2)
**Effort**: L — 2-4 weeks
**Lens consensus**: persona-enterprise, persona-redteam
**Source docs**: `AXIS_7_Collaboration_Social_Features_Cena.md:L75`
**Assignee hint**: claude-subagent-collab-saga
...
## Goal
Author ADR + scaffold for saga/process-manager pattern to coordinate cross-student flows (peer explain, collab whiteboard, team challenge) without dropping state onto StudentActor.

## Files
- docs/adr/NNNN-collab-saga-pattern.md
- src/actors/Cena.Actors/Collaboration/SagaCoordinator.cs

## Definition of Done
- ADR accepted; saga example with timeouts/compensations; tests.

## Reporting
complete via: node .agentdb/kimi-queue.js complete <id> --worker claude-subagent-collab-saga --result "<branch>"
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-023)
