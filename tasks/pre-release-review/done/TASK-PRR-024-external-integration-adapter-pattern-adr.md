# TASK-PRR-024: External-integration adapter pattern ADR

**Priority**: P1 — strongly recommended before launch (lens consensus: 2)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-enterprise, persona-sre
**Source docs**: `cena_axis5_teacher_workflow_features.md:L71`, `AXIS_10_Operational_Integration_Features.md:L159`
...
## Goal
ADR for external-integration adapter (Mashov, Classroom, SSO, Twilio, webhooks) with circuit-breaker, retry, DLQ, staleness badge conventions.

## Files
- docs/adr/NNNN-external-integration-adapter.md

## Definition of Done
- ADR accepted; reference adapter implementation for Mashov.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-024)
