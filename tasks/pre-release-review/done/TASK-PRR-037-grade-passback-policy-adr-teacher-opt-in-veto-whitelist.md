# TASK-PRR-037: Grade-passback policy ADR + teacher opt-in veto + whitelist

**Priority**: P1 — strongly recommended before launch (lens consensus: 4)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-educator, persona-ministry, persona-ethics, persona-sre
**Source docs**: `AXIS_10_Operational_Integration_Features.md:L104`, `AXIS_10_Operational_Integration_Features.md:L108`
...
## Goal
ADR governing grade-passback (Mashov/Classroom). Teacher opt-in veto per student, whitelist of grade types, idempotency.

## Files
- docs/adr/NNNN-grade-passback-policy.md
- integration

## Definition of Done
- ADR accepted; teacher UI; idempotency tests.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-037)
