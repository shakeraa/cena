# TASK-PRR-009: Parent→child claims binding + IDOR enforcement helper

**Priority**: P0 — ship-blocker (lens consensus: 3)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-redteam, persona-privacy, persona-enterprise
**Source docs**: `AXIS_4_Parent_Engagement_Cena_Research.md:L86`, `AXIS_4_Parent_Engagement_Cena_Research.md:L69`
...
**Tier**: mvp
**Epic**: EPIC-PRR-C — Parent Aggregate + age-band consent + IDOR enforcement

---

## Goal
Implement Parent aggregate + parent→child claim binding; expose a single IDOR-enforcement helper that every parent-scoped endpoint must call.

## Files
- src/actors/Cena.Actors/Parent/**
- src/shared/Cena.Infrastructure/Security/ParentChildAuthorization.cs
- integration tests for cross-parent access

## Definition of Done
- Middleware/helper blocks cross-family access; e2e IDOR tests pass; ADR on parent auth role.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-009)
