# TASK-PRR-033: Ministry Bagrut rubric DSL + version pinning + per-track sign-off

**Priority**: P1 — strongly recommended before launch (lens consensus: 2)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-educator, persona-ministry
**Source docs**: `cena_axis5_teacher_workflow_features.md:L160`, `AXIS_8_Content_Authoring_Quality_Research.md:L132`
...
## Goal
DSL for Bagrut rubrics, pin to version, sign-off workflow per track (3/4/5 unit).

## Files
- src/actors/Cena.Actors/ExamPrep/RubricDsl/**
- admin UI

## Definition of Done
- DSL v1; version pinned on every item; sign-off artifacts stored.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-033)
