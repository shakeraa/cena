# TASK-PRR-026: k-anonymity floor (k≥10) for classroom/teacher aggregates

**Priority**: P1 — strongly recommended before launch (lens consensus: 5)
**Effort**: S — 1-2 days
**Lens consensus**: persona-privacy, persona-redteam, persona-ethics, persona-sre, persona-educator
**Source docs**: `cena_axis5_teacher_workflow_features.md:L63`, `AXIS_7_Collaboration_Social_Features_Cena.md:L158`, `AXIS_4_Parent_Engagement_Cena_Research.md:L139`
...
## Goal
Add platform primitive enforcing k≥10 floor on every class/teacher aggregate, anonymous-signal display, DP analytics. Below threshold returns 'hidden'.

## Files
- src/shared/Cena.Infrastructure/Analytics/KAnonymityGuard.cs
- dashboard widgets

## Definition of Done
- Guard enforced platform-wide; tests on class of 5 → hidden; docs.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-026)
