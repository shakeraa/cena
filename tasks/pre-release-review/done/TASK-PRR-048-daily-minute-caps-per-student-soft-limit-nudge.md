# TASK-PRR-048: Daily-minute caps per student + soft-limit nudge

**Priority**: P1 — strongly recommended before launch (lens consensus: 2)
**Effort**: S — 1-2 days
**Lens consensus**: persona-finops, persona-ethics
...
## Goal
Cap per-student daily LLM minutes; soft-limit UI nudge; hard-limit 429.

## Files
- src/actors/Cena.Actors/RateLimit/**

## Definition of Done
- Cap enforced; nudge UX; tests.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-048)
