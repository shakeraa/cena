# TASK-PRR-021: Harden CSV bulk roster import (size, injection, UTF-8, normalization)

**Priority**: P1 — strongly recommended before launch (lens consensus: 3)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-redteam, persona-a11y, persona-ethics
**Source docs**: `AXIS_10_Operational_Integration_Features.md:L135`, `AXIS_10_Operational_Integration_Features.md:L104`
...
## Goal
Harden admin CSV roster import: size cap, CSV-injection (=,@,+,-) neutralization, UTF-8 BOM, NFKC name normalization, dry-run preview.

## Files
- src/admin/full-version/src/features/roster-import/**
- backend CsvRosterImportService

## Definition of Done
- Malicious CSV canary rejected; unit tests; accessibility review on preview UI.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-021)
