# TASK-PRR-039: Mashov sync circuit-breaker + synthetic probe + staleness badge

**Priority**: P1 — strongly recommended before launch (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-sre
**Source docs**: `feature-discovery-2026-04-20.md:L131`
...
## Goal
Circuit-breaker around Mashov sync; synthetic probe every 5m; UI staleness badge when >N min behind.

## Files
- src/actors/Cena.Actors/Integrations/Mashov/**
- UI staleness component

## Definition of Done
- CB opens under failure; probe metrics; badge visible to teachers.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-039)
