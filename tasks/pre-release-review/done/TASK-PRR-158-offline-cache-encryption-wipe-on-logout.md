# TASK-PRR-158: Offline cache encryption + wipe-on-logout

**Priority**: P1 — strongly-recommended pre-launch (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-redteam
**Source docs**: `AXIS_10_Operational_Integration_Features.md:L175`
**Assignee hint**: claude-subagent-security
**Tags**: source=pre-release-review-2026-04-20, lens=redteam, origin=tight-match-audit, src-audit-id=O-126
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-126)
**Tier**: mvp

---

## Goal
Offline cache encryption + wipe-on-logout

## Source
Raised by persona-redteam in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-126).
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-158)
