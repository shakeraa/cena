# TASK-PRR-152: Add new per-student projections to erasure cascade

**Priority**: P1 — strongly-recommended pre-launch (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-privacy
**Source docs**: `axis1_pedagogy_mechanics_cena.md:L150`
**Assignee hint**: claude-subagent-privacy
**Tags**: source=pre-release-review-2026-04-20, lens=privacy, origin=tight-match-audit, src-audit-id=O-120
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-120)
**Tier**: mvp

---

## Goal
Add new per-student projections to erasure cascade

## Source
Raised by persona-privacy in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-120).
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-152)
