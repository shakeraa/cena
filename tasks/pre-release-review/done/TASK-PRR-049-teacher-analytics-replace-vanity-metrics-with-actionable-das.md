# TASK-PRR-049: Teacher analytics: replace vanity metrics with actionable dashboards

**Priority**: P1 — strongly recommended before launch (lens consensus: 2)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-educator, persona-a11y
**Source docs**: `cena_axis5_teacher_workflow_features.md:L~`
...
## Goal
Replace minutes-spent vanity counters with actionable teacher dashboards: misconception clusters (session-scoped), intervention suggestions, accessibility-AA compliant.

## Files
- src/admin/full-version/src/views/teacher-analytics/**

## Definition of Done
- WCAG-AA; session-scoped data only; no theta leakage.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-049)
