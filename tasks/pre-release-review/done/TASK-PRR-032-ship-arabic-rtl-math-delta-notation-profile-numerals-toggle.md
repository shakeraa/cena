# TASK-PRR-032: Ship Arabic RTL math delta (notation profile, numerals toggle, function names)

**Priority**: P1 — strongly recommended before launch (lens consensus: 3)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-a11y, persona-educator, persona-ministry
**Source docs**: `axis3_accessibility_accommodations_findings.md:L133`, `axis3_accessibility_accommodations_findings.md:L143`
**Assignee hint**: kimi-coder
**Tags**: source=pre-release-review-2026-04-20, lens=a11y
**Status**: Not Started
...
## Goal
Deliver the delta for Arabic RTL math: notation profile toggle, Eastern Arabic numerals toggle, Arabic function-name mapping (sin→جا, cos→جتا, etc.).

## Files
- src/student/full-version/src/composables/useLocaleInference.ts
- locale ar math glossary

## Definition of Done
- Toggles wired; visual regression; Arabic-speaker review.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-032)
