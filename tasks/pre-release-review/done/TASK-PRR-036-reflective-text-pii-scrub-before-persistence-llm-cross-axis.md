# TASK-PRR-036: Reflective-text PII scrub before persistence + LLM (cross-axis)

**Priority**: P1 — strongly recommended before launch (lens consensus: 2)
**Effort**: S — 1-2 days
**Lens consensus**: persona-privacy, persona-redteam
**Source docs**: `axis2_motivation_self_regulation_findings.md:L136`, `axis1_pedagogy_mechanics_cena.md:L124`
...
## Goal
Scrub PII (names, phones, emails) from student reflective text before persist + before any LLM send.
...
## Definition of Done
- Scrubber applied at all reflective-text ingress points; tests with PII canaries.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-036)
