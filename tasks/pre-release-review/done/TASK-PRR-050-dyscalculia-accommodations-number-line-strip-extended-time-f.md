# TASK-PRR-050: Dyscalculia accommodations: number-line strip, extended time, finger-counting allowed
...
## Goal
Deliver dyscalculia accommodation pack: on-screen number line, extended time, finger-counting visual allowed in problem UI.

## Files
- src/actors/Cena.Actors/Accommodations/**
- student-web UI

## Definition of Done
- Toggleable; persists per enrollment; e2e test.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-050)
