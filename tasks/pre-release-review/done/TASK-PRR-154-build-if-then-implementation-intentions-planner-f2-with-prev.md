# TASK-PRR-154: Build if-then implementation-intentions planner (F2) with preview reminders

**Priority**: P1 — strongly-recommended pre-launch (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-educator
**Source docs**: `axis2_motivation_self_regulation_findings.md:L163`
**Assignee hint**: claude-subagent-pedagogy
**Tags**: source=pre-release-review-2026-04-20, lens=educator, origin=tight-match-audit, src-audit-id=O-042
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-042)
**Tier**: mvp

---

## Goal
Build if-then implementation-intentions planner (F2) with preview reminders

## Source
Raised by persona-educator in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-042).
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-154)
