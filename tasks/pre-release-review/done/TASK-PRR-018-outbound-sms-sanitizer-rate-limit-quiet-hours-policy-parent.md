# TASK-PRR-018: Outbound SMS sanitizer + rate-limit + quiet-hours policy (parent nudges)

**Priority**: P1 — strongly recommended before launch (lens consensus: 4)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-redteam, persona-ethics, persona-sre, persona-finops
**Source docs**: `AXIS_4_Parent_Engagement_Cena_Research.md:L109`, `AXIS_4_Parent_Engagement_Cena_Research.md:L64`, `AXIS_4_Parent_Engagement_Cena_Research.md:L157`
...
## Goal
All outbound SMS/WhatsApp (parent nudges) must pass sanitizer (no PII, allowlist templates), per-parent rate-limit, and quiet-hours (22:00–07:00 local).

## Files
- src/actors/Cena.Actors/ParentDigest/**
- Twilio/WhatsApp vendor adapter

## Definition of Done
- Unit tests assert blocked PII; rate-limit 429s; quiet-hours defer-not-drop.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-018)
