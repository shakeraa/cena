# TASK-PRR-159: Ship F5 'I'm Confused Too' anonymous signal

**Priority**: P1 — strongly-recommended pre-launch (lens consensus: 1)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-cogsci
**Source docs**: `AXIS_7_Collaboration_Social_Features_Cena.md:L105`
**Assignee hint**: claude-subagent-pedagogy
**Tags**: source=pre-release-review-2026-04-20, lens=cogsci, origin=tight-match-audit, src-audit-id=O-022
**Status**: Not Started
**Source**: tight-match audit 2026-04-20 (O-022)
**Tier**: mvp

---

## Goal
Ship F5 'I'm Confused Too' anonymous signal

## Source
Raised by persona-cogsci in persona YAMLs — see source docs above. Promoted from tight-match audit confirmed-orphans (prior audit ID O-022).
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-159)
