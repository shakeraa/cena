# TASK-PRR-051: Parent digest: opt-in purposes + unsubscribe-all link

**Priority**: P1 — strongly recommended before launch (lens consensus: 2)
**Effort**: S — 1-2 days
**Lens consensus**: persona-privacy, persona-ethics
**Source docs**: `AXIS_4_Parent_Engagement_Cena_Research.md:L~`
...
## Goal
Parent digests require explicit purpose-based opt-in; every message has one-tap unsubscribe-all.

## Files
- src/actors/Cena.Actors/ParentDigest/**

## Definition of Done
- Purpose model; unsubscribe link; compliance log.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-051)
