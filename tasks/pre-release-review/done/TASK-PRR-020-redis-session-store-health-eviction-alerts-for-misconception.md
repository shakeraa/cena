# TASK-PRR-020: Redis session-store health + eviction alerts for misconception scope

**Priority**: P1 — strongly recommended before launch (lens consensus: 1)
**Effort**: S — 1-2 days
**Lens consensus**: persona-sre
**Source docs**: `feature-discovery-2026-04-20.md:L112`
...
## Goal
Emit health and eviction metrics for Redis misconception session store; alert when evictions breach threshold (correctness impact).

## Files
- ops/prometheus/alerts-redis.yml
- Redis metrics exporter

## Definition of Done
- Alerts firing on synthetic load; runbook; dashboard.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-020)
