# TASK-PRR-015: Register every new misconception/PII store with RetentionWorker pre-release

**Priority**: P1 — strongly recommended before launch (lens consensus: 3)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-redteam, persona-privacy, persona-sre
**Source docs**: `AXIS_6_Assessment_Feedback_Research.md:L137`, `feature-discovery-2026-04-20.md:L56`
...
## Goal
Add RetentionWorker registration check at CI time — any new table/index containing misconception/PII must be declared in DataRetentionPolicy before build passes.

## Files
- scripts/ci/retention-registration-check.sh
- src/actors/Cena.Actors/Compliance/DataRetentionPolicy.cs

## Definition of Done
- CI scanner; unit tests for unregistered store; docs updated.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-015)
