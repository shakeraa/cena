# TASK-PRR-035: Sub-processor registry + DPAs (SSO, Mashov, Classroom, Twilio, Anthropic)

**Priority**: P1 — strongly recommended before launch (lens consensus: 2)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-privacy, persona-sre
**Source docs**: `AXIS_10_Operational_Integration_Features.md:L137`, `axis9_data_privacy_trust_mechanics.md:L277`
...
## Goal
Maintain registry of sub-processors with signed DPAs; expose to parents on request; ship-gate check before any new integration.

## Files
- docs/compliance/sub-processor-registry.md
- signed DPAs (private)

## Definition of Done
- Registry committed; DPAs on file; parent-view endpoint.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-035)
