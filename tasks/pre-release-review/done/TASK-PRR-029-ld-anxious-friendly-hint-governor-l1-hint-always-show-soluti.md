# TASK-PRR-029: LD/anxious-friendly hint-governor: L1 hint always, show-solution escape

**Priority**: P1 — strongly recommended before launch (lens consensus: 3)
**Effort**: S — 1-2 days
**Lens consensus**: persona-educator, persona-ethics, persona-a11y
**Source docs**: `axis1_pedagogy_mechanics_cena.md:L185`, `axis1_pedagogy_mechanics_cena.md:L133`
...
## Goal
Level 1 hint available immediately; delay gate applies only to L2/L3. Always-visible 'show me the solution' escape.

## Files
- src/actors/Cena.Actors/Hints/DeliveryGate.cs
- src/actors/Cena.Actors/Services/HintGenerationService.cs
- tests

## Definition of Done
- L1 never delayed; cohort-configurable L2/L3 delays; escape CTA always visible.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-029)
