# TASK-PRR-277: RTL/cross-locale CAS canonicalization — Hebrew bidi-marked answer correctness

**Priority**: normal
**Effort**: S-M
**Source docs**: claude-code Phase 3 self-audit 2026-04-29 (mock-exam runner SHOULD-FILE list).
**Assignee hint**: unassigned
**Tags**: source=exam-prep-phase-3-deferred,epic=epic-prr-n,i18n
**Status**: Ready
...
Close the i18n gap from Phase 3 of the mock-exam runner audit.
