# TASK-PRR-265: ADR-0059 R1 Per-source per-institute variant rate-limit caps
...
Close the R1 Per-source per-institute variant rate-limit caps gap from ADR-0059 §14.4. The mock-exam runner (exam-prep slice) is shipping in parallel; this task is the wrapper-rollout side that gates flag-flip on legal sign-off (PRR-249).
