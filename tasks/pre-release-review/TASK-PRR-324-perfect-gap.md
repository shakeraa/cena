# TASK-PRR-324: DDD aggregate refactor of ExamSimulationState (proper command handlers per ADR-0001)
...
**Tags**: source=exam-prep-perfect-gap-2026-04-29,epic=epic-prr-n,architecture
**Status**: Ready
...
DDD aggregate refactor of ExamSimulationState (proper command handlers per ADR-0001).
