# TASK-PRR-031: Localize MathAriaLabels.cs for he/ar speech rules + KaTeX→MathML gap

**Priority**: P1 — strongly recommended before launch (lens consensus: 2)
**Effort**: M — 1-2 weeks
**Lens consensus**: persona-a11y, persona-educator
**Source docs**: `axis3_accessibility_accommodations_findings.md:L99`, `axis3_accessibility_accommodations_findings.md:L121`
...
## Goal
Localize math-ARIA speech rules for Hebrew/Arabic; close KaTeX→MathML rendering gap where screen readers fall back to LaTeX source.

## Files
- src/shared/Cena.Infrastructure/Accessibility/MathAriaLabels.cs
- src/student/full-version/src/plugins/math-renderer/**

## Definition of Done
- he/ar MathML rendered; screen-reader e2e test passes.
...
- [Canonical task JSON](../../pre-release-review/reviews/tasks.jsonl) (id: prr-031)
