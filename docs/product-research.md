...
| Adaptive methodology switching | Verified across 7 competitors (see Feature Matrix above): all adjust difficulty/sequence, none switch teaching methodology itself — verified by direct analysis of each competitor's published documentation, research papers, and product descriptions as of March 2026 | Seamlessly switches between Socratic, spaced repetition, project-based, Feynman, worked examples, analogy-based, and retrieval practice |
...
2. **Adaptive methodology switching** — validated as novel: all 7 competitors adjust difficulty or sequence, but none switch the teaching method itself (verified by direct analysis of each competitor's published documentation, research papers, and product descriptions as of March 2026)
