...
**Tracked**: RDY-065 for root-cause investigation.
...
- The validator drift went undetected for an unknown period because
  ...
  through `BusMessageValidator.Validate`. Added to RDY-065's
...
3. ✅ File RDY-065 for Marten sequence-collision investigation.
4. ☐ Add a round-trip test: emulator-generated `BusConceptAttempt`
   ...
   future validator drift. (Tracked in RDY-065.)
5. ☐ Investigate the Marten v8 sequence path (RDY-065 Scope §2).
